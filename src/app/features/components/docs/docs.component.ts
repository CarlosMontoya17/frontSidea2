...
import { faArrowCircleUp, faBook, faCalendarDays, faPeopleArrowsLeftRight, faTrashCan } from '@fortawesome/free-solid-svg-icons';
...
export class DocsComponent implements OnInit {
  ...
  CardInfo: cardInfo[] = [
    {
      ...
      IconBtn: faBook,
      Input: false,
      Legend: "PARA VER LOS DOCUMENTOS ASIGNADOS A TI O SUBIDOS POR TI, DA CLICK EN VER.",
      LegendBtn: "VER",
      Title: "HISTORIAL",
      Width: 35
    },
    {
      ...
      Input: false,
      Legend: "PARA SUBIR UN DOCUMENTO Y ASIGNARLO A UN USUARIO MANUALMENTE, DA CLICK EN AÑADIR.",
      LegendBtn: "SUBIR",
      Title: "AÑADIR",
      Width: 35
    }
  ...
  public columns: ColDef[] = [
    { field: 'id', headerName: 'Id', filter: 'agMultiColumnFilter', cellStyle: { fontSize: '12px' }, width: 80, editable:true },
    { field: 'document', headerName: 'Documento', filter: 'agMultiColumnFilter', cellStyle: { fontSize: '12px' }, editable:true},
    { field: 'dataset', headerName: 'CURP', filter: 'agMultiColumnFilter', cellStyle: { fontSize: '12px' }, editable:true },
    { field: 'state', headerName: 'Estado', filter: 'agMultiColumnFilter', cellStyle: { fontSize: '12px' }, editable:true },
    { field: 'nameinside', headerName: 'Nombres', filter: 'agMultiColumnFilter', cellStyle: { fontSize: '12px' }, editable:true },
    { field: 'seller', headerName: 'Vendedor', filter: 'agMultiColumnFilter', cellStyle: { fontSize: '12px' }, editable:true },
    { field: 'bought', headerName: 'Comprador', filter: 'agMultiColumnFilter', cellStyle: { fontSize: '12px' }, editable:true },
    { field: 'uploadby', headerName: 'Subido por', filter: 'agMultiColumnFilter', cellStyle: { fontSize: '12px' }, editable:true },
    { field: 'createdAt', headerName: 'Fecha', filter: 'agMultiColumnFilter', cellStyle: { fontSize: '12px' }, editable:true },
    { field: 'corte', headerName: 'Corte', filter: 'agMultiColumnFilter', cellStyle: { fontSize: '12px' }, editable:true }
  ];
  ...
  getHistory(date:any): void {
    this.svc.getRegs(date).subscribe((data:any) => {
      this.rowData = data;
